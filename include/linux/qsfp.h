...
struct qsfp_upstream_ops {
	...
	void (*disconnect_phy)(void *priv, struct phy_device *phydev);
};
...
static inline void qsfp_upstream_set_signal_rate(struct qsfp_bus *bus,
...
static inline const char *qsfp_get_name(struct qsfp_bus *bus)
{
	return NULL;
}
